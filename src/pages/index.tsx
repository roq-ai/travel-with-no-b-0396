...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Travel with no boundaries`}</title>

        <meta
          name="description"
          content="Travel with no boundaries: Your comprehensive travel booking platform. Select your origin and destination, explore options for flights, trains, and buses, compare prices, and even check the CO2 footprint. All at your fingertips."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1682687220211-c471118c9e92?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHx0cmF2ZWx8ZW58MHx8fHwxNjk4ODUyNDM5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Travel with no boundaries: Your comprehensive travel booking platform. Select your origin and destination, explore options for flights, trains, and buses, compare prices, and even check the CO2 footprint. All at your fingertips.`}
            </Text>
            <Box
