...
export namespace Prisma {
  ...
  */
  ...
  interface providerFieldRefs {
    ...
    readonly tenant_id: FieldRef<'provider', 'String'>;
  }
  ...
  export type providerWhereInput = {
    ...
    image?: StringNullableFilter<'provider'> | string | null;
    ...
    tenant_id?: StringFilter<'provider'> | string;
  };
  ...
  export type providerScalarWhereWithAggregatesInput = {
    ...
    image?: StringNullableWithAggregatesFilter<'provider'> | string | null;
    ...
    tenant_id?: StringWithAggregatesFilter<'provider'> | string;
  };
